...
<body class="bg-white">
  <div class="d-flex align-items-center justify-content-center min-vh-100 bg-white">
    <div class="text-center p-4">
      ...
      <h2 class="fw-bold text-dark mt-2 mb-3">Página no encontrada</h2>

      <p class="text-muted mb-4" style="max-width: 400px; margin: 0 auto;">
        Lo sentimos, la sección o el recurso al que intentas acceder no existe en el sistema CEV o ha sido movido
        temporalmente.
      </p>
