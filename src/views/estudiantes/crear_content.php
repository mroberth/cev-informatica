<main class="main-content">
  <div class="mb-4">
    <h4 class="mb-1"><i class="bi bi-mortarboard me-2"></i>Crear Estudiante</h4>
    <p class="text-muted mb-0">Registra un estudiante vinculándolo a un usuario existente del sistema</p>
  </div>
    ...
    <div class="col-12">
      <div class="card border-0 shadow-sm rounded-3">
        <div class="card-body p-4">
          <form id="formCrearEstudiante" novalidate>
            <div class="row g-3">

              <div class="col-12 mb-2">
                <label for="id_usuario" class="form-label fw-semibold text-secondary small">
                  <i class="bi bi-person me-1"></i>Usuario (Estudiante)
                </label>
            ...
            <div class="d-flex gap-2">
              ...
              <a href="/a/estudiantes/consultar" class="btn btn-outline-secondary fw-semibold px-4">
